...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-white text-slate-600 text-xs py-8 border-t border-cyan-100 mt-12 shadow-2xs">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div>
          <h4 className="font-bold text-slate-900 text-sm mb-2">System Specs & Model Audit</h4>
        ...
        <div className="text-right md:text-right">
          <p className="font-semibold text-slate-700">National Informatics Centre (NIC) Compliance</p>
          <p className="mt-1 text-slate-500 text-[11px]">
            Data updated live via PostgreSQL <code className="text-cyan-700 font-semibold">nirman_db</code>.
          </p>
